...
> **`useDivider` API table (`api`)** — TypeScript-derived; not inlined here. See the live table at https://primereact.dev/docs/headless/components/divider or the installed `@primereact/types`.
