...
See [Primitive API](../../primitive/commandmenu/features.md#api) for `CommandMenuRoot`, `CommandMenuInput`, `CommandMenuList`, `CommandMenuItem`, `CommandMenuGroup`, `CommandMenuGroupHeader`, `CommandMenuHeader`, `CommandMenuFooter`, `CommandMenuEmpty` component documentation.

### Hooks

See [Headless API](../../headless/commandmenu/features.md#api) for `useCommandMenu` hook documentation.
