                ...
                <Splitter.Root defaultSizes={[50, 50]} orientation="vertical">
                    ...
                    <Splitter.Panel>
                        <Splitter.Root defaultSizes={[20, 80]}>
                            ...
                            <Splitter.Panel className="flex items-center justify-center">Panel 4</Splitter.Panel>
                        </Splitter.Root>
                    </Splitter.Panel>
                </Splitter.Root>
            </Splitter.Panel>
...
export default function StatefulDemo() {
    ...
    return (
        <Splitter.Root className="h-60! max-w-lg mx-auto" sizes={sizes} onResizeEnd={(e) => setSizes(e.sizes)}>
            <Splitter.Panel minSize={10} className="flex items-center justify-center">
...
export default function AdvancedDemo() {
    ...
    return (
        ...
        >
            ...
            <Splitter.Gutter className="w-0.25 relative">
                <Splitter.Thumb className="absolute inset-y-0 h-full rounded-none w-2 left-1/2 -translate-x-1/2 bg-surface-200 dark:bg-surface-700 hover:opacity-100 data-resizing:opacity-100 opacity-0 transition-opacity delay-100" />
            </Splitter.Gutter>
