...
See [Compare Primitive](../../primitive/compare/features.md#api) for the sub-component API reference.

### Hooks

See [useCompare](../../headless/compare/features.md#api) for the headless hook API reference.
