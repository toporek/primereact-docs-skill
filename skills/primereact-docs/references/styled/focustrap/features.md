...
See [Primitive API](../../primitive/focustrap/features.md#api) for `FocusTrap` component documentation.

### Hooks

See [Headless API](../../headless/focustrap/features.md#api) for `useFocusTrap` hook documentation.
