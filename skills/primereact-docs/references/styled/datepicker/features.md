...
export default function ValueTriggerDemo() {
    ...
    const removeDate = (e: ChipRootRemoveEvent, index: number) => {
        ...
        <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-2">
                ...
                >
                    <DatePicker.Trigger
                        as="div"
                        className="flex items-center gap-2 cursor-pointer w-full md:w-80 border border-(--p-inputtext-border-color) rounded-(--p-inputtext-border-radius) bg-(--p-inputtext-background) py-(--p-inputtext-padding-y) px-(--p-inputtext-padding-x)"
                    >
            ...
            <div className="flex flex-col gap-2">
                ...
                >
                    <DatePicker.Trigger
                        as="div"
                        className="flex items-center gap-1 cursor-pointer min-h-[2.5rem] w-full md:w-150 border border-(--p-inputtext-border-color) rounded-(--p-inputtext-border-radius) bg-(--p-inputtext-background) py-(--p-inputtext-padding-y) px-(--p-inputtext-padding-x)"
                    >
                        <DatePicker.Value placeholder="Pick dates...">
                            <div className="flex flex-wrap gap-1">
                                {multiDates.map((date, index) => (
                                    <Chip.Root key={index} className="py-0.5" onRemove={(e: ChipRootRemoveEvent) => removeDate(e, index)}>
            ...
            <div className="flex flex-col gap-2">
                ...
                >
                    <DatePicker.Trigger as={Button} variant="outlined" severity="secondary">
                        <Calendar />
                    </DatePicker.Trigger>
                    <DatePicker.Portal>
                        <DatePicker.Positioner>
...
import {
    DatePicker,
    type DatePickerCalendarContainerInstance,
                                            ...
                                            {groupIndex === 0 && (
                                                <>
                                                    <DatePicker.Header>
                                                        ...
                                                        <DatePicker.Title>
                                                            <DatePicker.SelectMonth>{datepicker?.getMonthName?.(month.month)}</DatePicker.SelectMonth>
                                                            <DatePicker.SelectYear>{month.year}</DatePicker.SelectYear>
                                                            <DatePicker.Decade />
                                                        </DatePicker.Title>
                                                    </DatePicker.Header>
                                                                        ...
                                                                        <>
                                                                            {week.map((date) => {
                                                                                ...
                                                                                return (
                                                                                    ...
                                                                                    >
                                                                                        <DatePicker.Day day={date} className="w-12 h-12 rounded-lg">
                                                                                            <div
...
See [Primitive API](../../primitive/datepicker/features.md#api) for `DatePickerRoot`, `DatePickerInput`, `DatePickerPopup`, `DatePickerCalendar`, `DatePickerDay`, `DatePickerMonth`, `DatePickerYear`, and all other sub-component documentation.

### Hooks

See [Headless API](../../headless/datepicker/features.md#api) for `useDatePicker` hook documentation.
