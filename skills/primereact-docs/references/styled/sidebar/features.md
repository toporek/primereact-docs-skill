    ...
    return (
        <div className="border border-surface-200 dark:border-surface-700 rounded-lg overflow-hidden">
            <Sidebar.Layout className="min-h-112 relative!">
                <Sidebar.Root id="preview" collapsible="icon" className="h-112">
                    <Sidebar.Spacer />
                    <Sidebar.Panel>
                        <Sidebar.Body>
                            <Sidebar.Header>
...
export default function MenuDemo() {
    ...
    return (
        <div className="border border-surface-200 dark:border-surface-700 rounded-lg overflow-hidden">
            <Sidebar.Layout className="min-h-112 relative!">
                <Sidebar.Root id="menu-demo" collapsible="icon" className="h-112">
                    <Sidebar.Spacer />
                    <Sidebar.Panel>
                        <Sidebar.Body>
                            <Sidebar.Header>
...
export default function DualDemo() {
    return (
        <div className="border border-surface-200 dark:border-surface-700 rounded-lg overflow-hidden">
            <Sidebar.Layout className="min-h-140 relative!">
                {/* Left sidebar - icon collapsible */}
                <Sidebar.Root id="nav" side="left" collapsible="icon" className="h-140" width="14rem">
                    <Sidebar.Spacer />
                    <Sidebar.Panel>
                        <Sidebar.Body>
                            <Sidebar.Header>
                ...
                <Sidebar.Root id="ai" side="right" collapsible="offcanvas" defaultOpen={false} className="h-140" width="18rem">
                    <Sidebar.Spacer />
                    <Sidebar.Panel>
                        <Sidebar.Body>
                            <Sidebar.Header>
    ...
    return (
        <div className="border border-surface-200 dark:border-surface-700 rounded-lg overflow-hidden">
            <Sidebar.Layout className="min-h-140 relative!">
                ...
                <Sidebar.Root id="iconbar" side="left" collapsible="icon" overlay openOnHover width="12rem" defaultOpen={false} className="h-140">
                    <Sidebar.Spacer />
                    <Sidebar.Panel>
                        <Sidebar.Body>
                            <Sidebar.Header>
                ...
                <Sidebar.Root id="secondary" side="left" width="14rem" className="h-140">
                    <Sidebar.Spacer />
                    <Sidebar.Panel>
                        <Sidebar.Body>
                            <Sidebar.Header>
...
export default function ChatDemo() {
    return (
        <div className="border border-surface-200 dark:border-surface-700 rounded-lg overflow-hidden">
            <Sidebar.Layout className="min-h-140 relative!">
                <Sidebar.Root id="chat-history" collapsible="icon" className="h-140" width="16rem">
                    <Sidebar.Spacer />
                    <Sidebar.Panel>
                        <Sidebar.Body>
                            <Sidebar.Header>
