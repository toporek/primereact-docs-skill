...
| style | CSSProperties \\| ((instance?: FloatLabelInstance) => undefined \\| CSSProperties) | null | The style to apply to the component. |
| className | string \\| ((instance?: FloatLabelInstance) => undefined \\| string) | null | The class name to apply to the component. |
