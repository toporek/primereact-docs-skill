...
| style | CSSProperties \\| ((instance?: LabelInstance) => undefined \\| CSSProperties) | null | The style to apply to the component. |
| className | string \\| ((instance?: LabelInstance) => undefined \\| string) | null | The class name to apply to the component. |
