...
export default function BothScrollbarsDemo() {
    return (
        <ScrollArea.Root className="h-80 max-w-sm mx-auto w-full rounded-md overflow-hidden">
            ...
            <ScrollArea.Scrollbar orientation="vertical" className="m-0!">
                <ScrollArea.Handle />
            </ScrollArea.Scrollbar>

            <ScrollArea.Scrollbar orientation="horizontal" className="m-0!">
                <ScrollArea.Handle />
            </ScrollArea.Scrollbar>
...
import { ScrollArea } from '@primereact/ui/scrollarea';
import { ScrollAreaRootProps } from '@primereact/ui/scrollarea';
import * as React from 'react';
        ...
        <div className="max-w-56 w-full mx-auto">
            ...
            <ScrollArea.Root className="h-72">
                ...
                <ScrollArea.Scrollbar className="rounded-full bg-indigo-500/10! w-2!">
                    <ScrollArea.Handle className="relative bg-transparent! after:content-[''] after:rounded-full after:bg-indigo-500 after:absolute after:inset-0 active:after:scale-y-90 active:after:scale-x-75 after:transition-transform" />
                </ScrollArea.Scrollbar>
            </ScrollArea.Root>
        </div>
    );
