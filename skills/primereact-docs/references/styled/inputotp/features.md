...
See [Primitive API](../../primitive/inputotp/features.md#api) for `InputOtpRoot` and `InputOtpText` component documentation.

### Hooks

See [Headless API](../../headless/inputotp/features.md#api) for `useInputOtp` hook documentation.
