...
See [Timeline Primitive](../../primitive/timeline/features.md#api) for the full sub-component API.

### Hooks

See [useTimeline](../../headless/timeline/features.md#api) for the headless hook API.
