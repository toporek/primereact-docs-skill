...
## Working Example
    ...
    <span className='text-xl font-semibold'>Quickstart your project with our PrimeReact + Vite template</span>
    <div className='text-sm'>Use this Vite template pre-configured with PrimeReact to quickly start building your app with ready-to-use UI components and styles.</div>
