...
Style mode offers theming based on a design token based architecture. See the [styled mode](https://v11.primereact.org/docs/theming/styled) documentation for details such as building your own theme.
...
Defines the shared pass through properties per component type. Visit the [Pass Through Props](https://v11.primereact.org/docs/passthrough) documentation for more information.
