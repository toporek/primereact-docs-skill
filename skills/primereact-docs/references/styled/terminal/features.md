...
import { TerminalCommandInstance, TerminalResponse, TerminalRootInstance } from 'primereact/terminal';
import { Terminal } from '@primereact/ui/terminal';
...
```tsx
'use client';
import { TerminalCommandItem, TerminalResponse, TerminalRootInstance } from 'primereact/terminal';
import { Terminal } from '@primereact/ui/terminal';
import * as React from 'react';
...
See [Terminal Primitive](../../primitive/terminal/features.md#api) for the full sub-component API.

### Hooks

See [useTerminal](../../headless/terminal/features.md#api) for the headless hook API.
