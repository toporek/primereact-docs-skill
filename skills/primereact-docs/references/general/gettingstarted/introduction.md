...
the library maintainer to extend this API by adding new props or events. With [Pass Through](https://v11.primereact.org/docs/passthrough) this limitation has been eliminated since, you'll be able to access the internal of the components to add
