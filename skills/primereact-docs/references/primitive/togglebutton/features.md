...
export default function ToggleButtonPTDemo() {
    return (
...
> **API/props table for `ToggleButtonRoot` (`pt`) is generated from upstream TypeScript types and is not yet mirrored — see the installed package types or the upstream docs. (TODO: mirror in v2.)
...
> **API/props table for `ToggleButtonIndicator` (`pt`) is generated from upstream TypeScript types and is not yet mirrored — see the installed package types or the upstream docs. (TODO: mirror in v2.)
