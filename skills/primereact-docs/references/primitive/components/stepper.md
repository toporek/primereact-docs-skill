...
|:------|:------|:------|
| root | StepperRootPassThroughType> | Used to pass attributes to the root's DOM element. |
| list | StepperRootPassThroughType> | Used to pass attributes to the list's DOM element. |
| step | StepperRootPassThroughType> | Used to pass attributes to the step's DOM element. |
| header | StepperRootPassThroughType> | Used to pass attributes to the header's DOM element. |
| number | StepperRootPassThroughType> | Used to pass attributes to the number's DOM element. |
| title | StepperRootPassThroughType> | Used to pass attributes to the title's DOM element. |
| separator | StepperRootPassThroughType> | Used to pass attributes to the separator's DOM element. |
| panels | StepperRootPassThroughType> | Used to pass attributes to the panels's DOM element. |
| panel | StepperRootPassThroughType> | Used to pass attributes to the panel's DOM element. |
| item | StepperRootPassThroughType> | Used to pass attributes to the item's DOM element. |
| content | StepperRootPassThroughType> | Used to pass attributes to the content's DOM element. |
...
| Label | Type | Description |
|:------|:------|:------|
| root | StepperListPassThroughType> | Used to pass attributes to the root's DOM element. |
...
| Label | Type | Description |
|:------|:------|:------|
| root | StepperItemPassThroughType> | Used to pass attributes to the root's DOM element. |
...
| Label | Type | Description |
|:------|:------|:------|
| root | StepperStepPassThroughType> | Used to pass attributes to the root's DOM element. |
...
| Label | Type | Description |
|:------|:------|:------|
| root | StepperHeaderPassThroughType> | Used to pass attributes to the root's DOM element. |
...
| Label | Type | Description |
|:------|:------|:------|
| root | StepperNumberPassThroughType> | Used to pass attributes to the root's DOM element. |
...
| Label | Type | Description |
|:------|:------|:------|
| root | StepperTitlePassThroughType> | Used to pass attributes to the root's DOM element. |
...
| Label | Type | Description |
|:------|:------|:------|
| root | StepperSeparatorPassThroughType> | Used to pass attributes to the root's DOM element. |
...
| Label | Type | Description |
|:------|:------|:------|
| root | StepperPanelsPassThroughType> | Used to pass attributes to the root's DOM element. |
...
| Label | Type | Description |
|:------|:------|:------|
| root | StepperPanelPassThroughType> | Used to pass attributes to the root's DOM element. |
...
| Label | Type | Description |
|:------|:------|:------|
| root | StepperContentPassThroughType> | Used to pass attributes to the root's DOM element. |
