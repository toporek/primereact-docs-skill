...
|:------|:------|:------|
| root | PanelRootPassThroughType> | Used to pass attributes to the root's DOM element. |
| header | PanelRootPassThroughType> | Used to pass attributes to the header's DOM element. |
| trigger | PanelRootPassThroughType> | Used to pass attributes to the trigger's DOM element. |
| title | PanelRootPassThroughType> | Used to pass attributes to the title's DOM element. |
| content | PanelRootPassThroughType> | Used to pass attributes to the content's DOM element. |
| contentOuter | PanelRootPassThroughType> | Used to pass attributes to the content outer wrapper's DOM element. |
| contentInner | PanelRootPassThroughType> | Used to pass attributes to the content inner wrapper's DOM element. |
| footer | PanelRootPassThroughType> | Used to pass attributes to the footer's DOM element. |
| indicator | PanelRootPassThroughType> | Used to pass attributes to the indicator's DOM element. |
...
| Label | Type | Description |
|:------|:------|:------|
| root | PanelHeaderPassThroughType> | Used to pass attributes to the root's DOM element. |
...
| Label | Type | Description |
|:------|:------|:------|
| root | PanelTitlePassThroughType> | Used to pass attributes to the root's DOM element. |
...
| Label | Type | Description |
|:------|:------|:------|
| root | PanelTriggerPassThroughType> | Used to pass attributes to the root's DOM element. |
...
| Label | Type | Description |
|:------|:------|:------|
| root | PanelIndicatorPassThroughType> | Used to pass attributes to the root's DOM element. |
...
| Label | Type | Description |
|:------|:------|:------|
| root | PanelContentPassThroughType> | Used to pass attributes to the root's DOM element. |
...
| Label | Type | Description |
|:------|:------|:------|
| root | PanelFooterPassThroughType> | Used to pass attributes to the root's DOM element. |
