...
- The [Figma UI Kit](../../../styled/add-ons/uikit/overview.md) uses these names, so a change made by a designer maps to the token a developer edits instead of being translated by hand.
- The [Theme Designer](../../../styled/add-ons/designer/guide.md) edits tokens through a UI and exports a preset. With SASS this was not possible, since a theme only existed once compiled.
...
The [styled mode guide](../../../styled/guides/theming/styled.md) covers `definePreset`, the full token reference, dark mode setup and the update utilities.
...
import { Select as PRSelect, type SelectRootProps } from 'primereact/select';
...
```jsx
// v11
import { toast, Toaster } from 'primereact/toaster';
...
| v10         | v11            | Example                                        |
| ----------- | -------------- | ---------------------------------------------- |
| `InputMask` | `useMask`      | [InputMask](../../../styled/components/inputmask.md) |
| `KeyFilter` | `useKeyFilter` | [KeyFilter](../../../styled/components/keyfilter.md) |
| `ScrollTop` | `useScrollTop` | [useScrollTop](../../../hooks/use-scrolltop.md)      |
| `OrderList` | `useOrderList` | [OrderList](../../../styled/components/orderlist.md) |
| `PickList`  | `usePickList`  | [PickList](../../../styled/components/picklist.md)   |
...
- [Configuration](../../../styled/guides/configuration.md), provider options, theme, locale, CSP
- [Styled mode](../../../styled/guides/theming/styled.md), building a theme preset from design tokens
