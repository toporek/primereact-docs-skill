    ...
    return (
        <div>
            <div style={{ position: 'relative', height: '240px' }}>
                <SpeedDial.Root visible={true} direction="up" style={{ position: 'absolute', right: 0, bottom: 0 }}>
...
> **API/props table for `SpeedDialRoot` (`pt`) is generated from upstream TypeScript types and is not yet mirrored — see the installed package types or the upstream docs. (TODO: mirror in v2.)
...
> **API/props table for `SpeedDialTrigger` (`pt`) is generated from upstream TypeScript types and is not yet mirrored — see the installed package types or the upstream docs. (TODO: mirror in v2.)
...
> **API/props table for `SpeedDialList` (`pt`) is generated from upstream TypeScript types and is not yet mirrored — see the installed package types or the upstream docs. (TODO: mirror in v2.)
...
> **API/props table for `SpeedDialItem` (`pt`) is generated from upstream TypeScript types and is not yet mirrored — see the installed package types or the upstream docs. (TODO: mirror in v2.)
...
> **API/props table for `SpeedDialAction` (`pt`) is generated from upstream TypeScript types and is not yet mirrored — see the installed package types or the upstream docs. (TODO: mirror in v2.)
