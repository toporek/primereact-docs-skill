...
```tsx
import { Splitter, SplitterGutter, SplitterPanel, SplitterThumb } from '@/components/ui/splitter';
                ...
                <Splitter defaultSizes={[50, 50]} orientation="vertical">
                    ...
                    <SplitterPanel>
                        <Splitter defaultSizes={[20, 80]}>
                            <SplitterPanel className="flex items-center justify-center">Panel 3</SplitterPanel>
                            <SplitterGutter>
                                <SplitterThumb />
                            </SplitterGutter>
                            <SplitterPanel className="flex items-center justify-center">Panel 4</SplitterPanel>
                        </Splitter>
                    </SplitterPanel>
                </Splitter>
            </SplitterPanel>
...
export default function StatefulDemo() {
    ...
    return (
        <Splitter className="h-60! max-w-lg mx-auto" sizes={sizes} onResizeEnd={(e) => setSizes(e.sizes)}>
            <SplitterPanel minSize={10} className="flex items-center justify-center">
                Panel 1 ({sizes[0].toFixed(1)}%)
            </SplitterPanel>
            <SplitterGutter>
                <SplitterThumb />
            </SplitterGutter>
            <SplitterPanel minSize={10} className="flex items-center justify-center">
                Panel 2 ({sizes[1].toFixed(1)}%)
            </SplitterPanel>
        </Splitter>
    );
}
    ...
    return (
        ...
        >
            ...
            <SplitterGutter className="w-0.25 relative">
                <SplitterThumb className="absolute inset-y-0 h-full rounded-none w-2 left-1/2 -translate-x-1/2 bg-surface-200 dark:bg-surface-700 hover:opacity-100 data-resizing:opacity-100 opacity-0 transition-opacity delay-100" />
            </SplitterGutter>
...
See [Primitive API](../../primitive/splitter/features.md#api) for `SplitterRoot`, `SplitterPanel`, `SplitterGutter`, `SplitterThumb` component documentation.

### Hooks

See [Headless API](../../headless/splitter/features.md#api) for `useSplitter` hook documentation.
