    ...
    return (
        <Accordion className="max-w-md mx-auto">
            <AccordionPanel value="1">
                <AccordionTrigger>About the role and team</AccordionTrigger>
                <AccordionContent>
                    <p>
            ...
            <AccordionPanel value="2">
                <AccordionTrigger>Day-to-day responsibilities</AccordionTrigger>
                <AccordionContent>
                    <p>
            ...
            <AccordionPanel value="3">
                <AccordionTrigger>What we are looking for</AccordionTrigger>
                <AccordionContent>
                    <p>
            ...
            <AccordionPanel value="4">
                <AccordionTrigger>Compensation and benefits</AccordionTrigger>
                <AccordionContent>
                    <p>
