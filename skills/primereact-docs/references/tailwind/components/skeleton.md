...
See [Primitive API](../../primitive/components/skeleton.md#api) for sub-component documentation.

### Hooks

See [Headless API](../../headless/components/skeleton.md#api) for hook documentation.

### Accessibility

See [Skeleton Primitive](../../primitive/components/skeleton.md#accessibility) for WAI-ARIA compliance details and keyboard support.
