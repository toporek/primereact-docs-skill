...
```tsx
import { Carousel, CarouselContent, CarouselItem, CarouselNext, CarouselPrev } from '@/components/ui/carousel';
...
export default function Preview() {
    return (
        <Carousel className="max-w-sm mx-auto" slidesPerPage={2.45} spacing={20}>
            ...
            <CarouselContent>
                {albums.map((album) => (
                    <CarouselItem key={album.title} className="w-full relative">
...
function BasicDemo() {
    return (
        <div className="mt-8 mb-16">
            <Carousel className="max-w-xl mx-auto" align="center">
                <CarouselContent className="h-[240px]">
                    {Array.from({ length: 5 }).map((_, i) => (
                        <CarouselItem key={i}>
                            <div className="h-full text-5xl font-semibold bg-surface-50 dark:bg-surface-900 text-surface-950 dark:text-surface-0 flex flex-col items-center justify-center gap-6 rounded-xl border border-surface">
                                <span>{i + 1}</span>
                            </div>
                        </CarouselItem>
                    ))}
...
function LoopDemo() {
    return (
        <div className="mt-8 mb-16">
            <Carousel className="max-w-xl mx-auto" align="center" loop slidesPerPage={1.75}>
                <CarouselContent className="h-[240px]">
                    {Array.from({ length: 5 }).map((_, i) => (
                        <CarouselItem key={i}>
                            <div className="h-full text-5xl font-semibold bg-surface-50 dark:bg-surface-950 text-surface-950 dark:text-surface-0 flex flex-col items-center justify-center gap-6 rounded-xl border border-surface">
...
import type { CarouselRootChangeEvent } from 'primereact/carousel';
    ...
    return (
        <div className="mt-8 mb-16">
            <div className="max-w-2xl mx-auto">
                <Carousel slide={selectedImage} onSlideChange={(e: CarouselRootChangeEvent) => setSelectedImage(Number(e.value ?? 0))} align="center">
                    <CarouselContent className="h-[396px]">
                        {images.map((_, i) => (
                ...
                <Carousel className="mt-3" spacing={8} align="center" slide={selectedImage}>
                    <CarouselContent className="h-[90px]">
                        {images.map((_, i) => (
                            <CarouselItem
                                key={i}
