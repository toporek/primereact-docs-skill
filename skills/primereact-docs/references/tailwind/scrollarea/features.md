        ...
        <div className="max-w-56 w-full mx-auto">
            ...
            <ScrollArea className="h-72">
                ...
                <ScrollAreaScrollbar className="rounded-full bg-indigo-500/10 w-2">
                    <ScrollAreaThumb className="relative bg-transparent after:content-[''] after:rounded-full after:bg-indigo-500 after:absolute after:inset-0 active:after:scale-y-90 active:after:scale-x-75 after:transition-transform" />
                </ScrollAreaScrollbar>
            </ScrollArea>
        </div>
    );
