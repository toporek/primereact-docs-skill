...
export default function Preview() {
    return (
        <div className="flex flex-col gap-1.5 mx-auto w-full max-w-3xs">
            <Label htmlFor="tw-basic-inputnumber">Inventory</Label>
            <InputNumber id="tw-basic-inputnumber" defaultValue={182934} />
...
```tsx
'use client';
import { AngleDown, AngleUp, Minus, Plus } from '@primeicons/react';
        ...
        <div className="flex flex-wrap gap-4">
            <div className="flex-auto">
                ...
                <InputGroup>
                    ...
                    />
                    <InputGroupAddon className="flex-col">
            ...
            <div className="flex-auto">
                ...
                <IconField>
                    <IconFieldInset onClick={() => setValue3((prev) => Number(prev) + 0.25)} className="cursor-pointer">
                        <Plus></Plus>
                    </IconFieldInset>
                    <InputText
...
export default function VerticalDemo() {
    ...
    return (
        <div className="flex justify-center">
            <InputGroup className="flex-col w-12">
                <InputGroupAddon className="p-0!">
                    <Button
                        severity="secondary"
                        iconOnly
                        className="w-12 rounded-se-md! rounded-es-none!"
                ...
                <InputGroupAddon className="p-0!">
                    <Button
                        severity="secondary"
                        iconOnly
                        className="w-12 rounded-se-none! rounded-es-md!"
                        onClick={() => setValue((prev) => Number(prev) - 1)}
                    >
                        <Minus />
                    </Button>
...
import { InputNumber, type InputNumberValueChangeEvent } from '@/components/ui/inputnumber';
import { Label } from '@/components/ui/label';
import * as React from 'react';
